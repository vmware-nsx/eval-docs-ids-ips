...
* [Run Deployment Script](3-RunScript.md)
* [Verify Lab Deployment](4-VerifyDeployment.md)
* [Initial IDS/IPS Configuration](5-InitialConfiguration.md)
* [Detecting a simple Intrusion](6-DetectingASimpleIntrusion.md)
* [Detecting an Advanced Attack](7-DetectinganAdvancedAttack.md)
