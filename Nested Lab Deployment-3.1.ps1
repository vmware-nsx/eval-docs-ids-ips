...
# NSX-T Configuration
$NSXLicenseKey = "" #Provide NSX License Key !
...
$T0GatewayInterfaceAddress = "10.114.222.125" # should be a routable address
...
if($postDeployNSXConfig -eq 1) {
    ...
    if($runT0Gateway -eq 1) {
        ...
        $edgeClusterNodePath = $policyEdgeClusterPath + "/edge-nodes/0" #+ $edgeClusterMember
